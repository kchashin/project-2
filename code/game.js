...
function Speedup(pos){
	this.basePos = this.pos = pos.plus(new Vector1(0.8,0.5));
	this.size = new Vector1 (0.6,0.6);
	this.wobble1 = Math.random() *Math.PI *5;
}
Speedup.prototype.type = 'speedup';
...
Speedup.prototype.act = function(step){
